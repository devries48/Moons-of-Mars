...
[ExecuteAlways]
public class KeplerOrbitLine : MonoBehaviour
{
	/// <summary>
	...
	private KeplerVector3d[] _orbitPoints;
	...
	private void LateUpdate()
	{
		...
		if (LineRendererReference != null && _moverReference.AttractorSettings.AttractorObject != null)
		{
			...
			_moverReference.OrbitData.GetOrbitPointsNoAlloc(
				ref _orbitPoints,
				OrbitPointsCount,
				new KeplerVector3d(attractorPosHalf.x, attractorPosHalf.y, attractorPosHalf.z),
	...
	private void ShowAscNode()
	{
        ...
        if (_moverReference.OrbitData.GetAscendingNode(out KeplerVector3d ascNode))
        {
	...
	{
		var attractorPosHalf = _moverReference.AttractorSettings.AttractorObject.position;
		var attractorPos = new KeplerVector3d(attractorPosHalf.x, attractorPosHalf.y, attractorPosHalf.z);
