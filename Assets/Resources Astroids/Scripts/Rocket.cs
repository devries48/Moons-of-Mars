...
namespace Game.Astroids
{
    ...
    {
        [Header("Spaceship")][Header("Weapon & bullet")][SerializeField, Tooltip("Select a gun prefab")] GameObject gun; [SerializeField, Tooltip("Select a bullet prefab")] GameObject bullet; [SerializeField, Tooltip("Lifetime in seconds")] float bulletLifetime = 10f; [SerializeField, Tooltip("Fire rate in seconds")] float fireRate = 0.5f; [SerializeField] float fireForce = 350f; float thrust = 6f; float rotationSpeed = 180f; float MaxSpeed = 4.5f; Rigidbody _rb; bool _canShoot = true; void Start()
        {
