...
public static class KeplerOrbitUtils
{
    ...
    public static KeplerVector3d RotateVectorByAngle(KeplerVector3d v, double angleRad, KeplerVector3d n)
    {
    ...
    /// </summary>
    public static KeplerVector3d CalcCircleOrbitVelocity(KeplerVector3d attractorPos, KeplerVector3d bodyPos, double attractorMass, KeplerVector3d orbitNormal, double gConst)
    {
        KeplerVector3d distanceVector = bodyPos - attractorPos;
        double dist = distanceVector.magnitude;
        double MG = attractorMass * gConst;
        double vScalar = Math.Sqrt(MG / dist);
        return KeplerVector3d.Cross(distanceVector, -orbitNormal).normalized * vScalar;
    }
    ...
    public static KeplerVector3d CalcCenterOfMass(KeplerVector3d pos1, double mass1, KeplerVector3d pos2, double mass2)
    {
